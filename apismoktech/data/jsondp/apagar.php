...
$detalhespedido->iddetalhespedido = $data->iddetalhespedido;


    //vamos tentar executar o cadastro
    if($detalhespedido->apagar()){
        //iremos retornar ao internalta
        //a mensagem de cadastro realizado
        //e o codigo de status 201 de criado
        //header('HTTP/1.0 201');
        header('HTTP/1.0 200');
        echo json_encode(array("mensagem"=>"item do detalhespedido apagado com sucesso"));
